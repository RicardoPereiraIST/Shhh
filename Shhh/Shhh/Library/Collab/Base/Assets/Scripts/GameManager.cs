...
public class GameManager : MonoBehaviour
{
    ...
    public Dictionary<int, Dictionary<int, InformationSet>> info = new Dictionary<int, Dictionary<int, InformationSet>>();
    ...
    public void writeToFile()
    {
        ...
        {
            logFile.WriteLine("Level " + l + "\r\n");
            foreach(int a in info[l].Keys)
            {
                logFile.WriteLine("Attempt " + a + "\r\n");
